  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div data-aos="fade-down" className="mx-auto max-w-2xl sm:text-center">
        ...
        <div data-aos="fade-right" className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
